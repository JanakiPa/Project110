...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/v6RHIaoqH/model.json',modelLoaded())
...
function gotResult(error, results){
    if (error) {
        console.error(error);}
            ...
            document.getElementById("result_gesture").innerHTML=results[1].label;
